...
这需要用到一些技术和资源，其中文档 doc/docx 文档的解析在文库已成熟基数，文档存储计划使用网盘个人存储。

现有实现 wordonline 的需求，还存在一些难点，一是网盘提供的接口有限，二是文档编辑后保存成 `docx` 的技术尚未成熟。

这给 wordonline 的后端带来比较复杂的需求，后端关联到 前端、网盘、rtcs 服务多方的通讯。
